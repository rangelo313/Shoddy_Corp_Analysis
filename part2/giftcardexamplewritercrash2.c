...
// Break it up so that we don't have long functions!  Good programmng style!
//  (JAC: This is so wrong.  Global variable use / initialization is a 
//  terrible thing to do.)
void setupgc() {
	examplegc.num_bytes = 116; //500
	...
	examplegcac.amount_added = 1073741825; //cause this to int overflow since it adds itelf.
